...
El contador termina el **21 de septiembre de 2026 a las 00:00 en Perú (UTC−05:00)**. En ese instante aparece automáticamente la felicitación. La carta también aparece si se visita la página después de esa fecha, sin reiniciar el contador para otro año.

## Archivos

- `index.html`: textos y carta de cumpleaños.
- `styles.css`: diseño adaptable a móviles y computadoras.
- `script.js`: fecha, contador, revelado y confeti con respeto a movimiento reducido.
- `dazai.png`: ilustración original generada con la herramienta integrada ImageGen.
- `.nojekyll`: publicación estática directa.

GitHub Pages: rama `main`, carpeta raíz. Todos los recursos usan rutas relativas. Las fuentes de Google son opcionales; hay fuentes de respaldo. La hora depende del reloj del dispositivo visitante.
